export const RULES_SECTIONS = [
    ...
    },
    {
        ...
        bullets: [
            'QTE: timed precision stop.',
            'Mash: rapid input meter race.',
            'Pattern: memory reproduction sequence.',
            'Rhythm: hit-window timing accuracy.',
            'Quiz: correct answer for success branch.',
        ],
    },
    {
        id: 'limits',
